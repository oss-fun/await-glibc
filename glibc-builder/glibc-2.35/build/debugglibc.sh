...
SOURCE_DIR="/home/materialofmouse/await-glibc/glibc-builder/glibc-2.35"
BUILD_DIR="/home/materialofmouse/await-glibc/glibc-builder/glibc-2.35/build/"
CMD_FILE="/home/materialofmouse/await-glibc/glibc-builder/glibc-2.35/build/debugglibc.gdb"
CONTAINER=false
DIRECT=true
STATIC=false
SYMBOLSFILE=true
...
WAIT_FOR_DEBUGGER=1 /home/materialofmouse/await-glibc/glibc-builder/glibc-2.35/build/testrun.sh --tool=container ${TESTCASE} &
gdb -x ${TESTCASE}.gdb
elif [ "$STATIC" == true ]
then
gdb ${TESTCASE}
